...
function generateParameterList() {
    ...
    // The following variables are mesh specific so based off what type of mesh is being worked with collects the
...
// Handles adding the tracked variables for position to the GUI and manipulation events of those tracked variables
...
// Handles adding the tracked variables for rotation to the GUI and manipulation events of those tracked variables
...
// Handles adding the tracked variables for scaling to the GUI and manipulation events of those tracked variables
...
// Handles adding the tracked variables for geometry to the GUI and manipulation events of those tracked variables
...
// Handles adding the tracked variables for material to the GUI and manipulation events of those tracked variables
...
function updateMesh() {
    ...
    if ( mesh.geometry instanceof THREE.BoxGeometry ) {
        ...
        newGeo = new THREE.SphereGeometry( parameters.Radius, parameters.Width_Segments, parameters.Height_Segments,
                                               parameters.Phi_Start, parameters.Phi_Length, parameters.Theta_Start,
                                               parameters.Theta_Length );
    } else if ( mesh.geometry instanceof THREE.CylinderGeometry ) {
        newGeo = new THREE.CylinderGeometry( parameters.Radius_Top, parameters.Radius_Bot, parameters.Height,
