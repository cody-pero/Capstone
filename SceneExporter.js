...
THREE.SceneExporter.prototype = {
    ...
    parse: function (scene) {
        ...
        function NumConstantString(c) {
            ...
            var constants = ["NearestFilter", "NearestMipMapNearestFilter",
        ...
        function LightString(o, n) {
            ...
            if (o instanceof THREE.AmbientLight) {
                ...
                var output = [
                    ...
                    '	"target"    : ' + LabelString(getObjectName(o.target)) +
                    ( o.children.length ? ',' : '' )
        ...
        function GeometryString(g) {
            ...
            if (g instanceof THREE.SphereGeometry) {
                ...
                if (g.sourceType === "ascii" || g.sourceType === "ctm" || g.sourceType === "stl"
                    || g.sourceType === "vtk") {
        ...
        function MaterialString(m) {
            ...
            if (m instanceof THREE.MeshBasicMaterial) {
                ...
                var output = [
                    ...
                    LabelString(getTextureName(m.specularMap)) + ',' : '', m.lightMap ? '	' +
                    '	"lightMap" : ' + LabelString(getTextureName(m.lightMap)) + ',' : '',
                ...
                var output = [
                    ...
                    + ',' : '', m.bumpMap ? '		"bumpMap" : ' +
                    LabelString(getTextureName(m.bumpMap)) + ',' : '',
