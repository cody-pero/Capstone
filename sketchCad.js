...
// Container the dom tree element that holds the renderer, scene - holds relevent three.js data, camera- viewer,
// renderer - object used to render three.js code to the screen, controls- camera controls used for moving,
// mesh - stores the mesh we are currently working with
...
// next available id ******************* check out a way to carry over the id value to avoid duplicates when saving/loading
var id = 0;
//**********************************************************************************************************************
...
function rebuildDropDown() {
    ...
    for ( var i = 0; i < scene.children.length; i++ ) {
        // Checks if this scene element should be added or if its part of the grid or other default element
...
function changeEditorDiv() {
    ...
    // If the selection is a mesh highlight and display editor if not (cameras, lights, etc) do not highlight it
...
function onMouseClick( event ) {
    ...
    if ( intersects.length > 0 ) {
        ...
        // If explode is enabled the first intersected face is also selected and the face editor is displayed
        if ( mode == "explode" ) {
