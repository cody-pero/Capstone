 ...
 *
 * Used to provide the editor gui's
 */
var dat = dat || {};
dat.gui = dat.gui || {};
dat.utils = dat.utils || {};
...
dat.utils.common = function () {
    ...
    return {
        BREAK: {}, extend: function (c) {
            ...
            return function () {
                for (var d = a.call(arguments), f = c.length - 1; f >= 0; f--)d =
                    [c[f].apply(this, d)];
                return d[0]
            }
        },
        each: function (a, d, f) {
            if (e && a.forEach === e)a.forEach(d, f); else if (a.length === a.length + 0)
...
dat.dom.dom = function (e) {
    ...
    var d = /(\d+(\.\d+)?)px/, f = {
        makeSelectable: function (b, a) {
            ...
            switch (m) {
                case "MouseEvents":
                    l.initMouseEvent(a, d.bubbles || false, d.cancelable || true, window,
                        d.clickCount || 1, 0, 0, d.x || d.clientX || 0, d.y || d.clientY ||
                ...
                case "KeyboardEvents":
                    ...
                    m(a, d.bubbles || false, d.cancelable, window, d.ctrlKey, d.altKey, d.shiftKey,
            ...
            b.removeEventListener ? b.removeEventListener(a, d, c || false) : b.detachEvent &&
            b.detachEvent("on" + a, d);
            return f
        }, addClass: function (b, a) {
            if (b.className === void 0)b.className = a; else if (b.className !== a) {
                var d = b.className.split(/ +/);
                if (d.indexOf(a) == -1)d.push(a), b.className = d.join(" ").replace(/^\s+/, "")
                    .replace(/\s+$/, "")
            }
            return f
            ...
            return a(b["border-left-width"]) + a(b["border-right-width"]) + a(b["padding-left"])
                + a(b["padding-right"]) + a(b.width)
        }, getHeight: function (b) {
            b = getComputedStyle(b);
            return a(b["border-top-width"]) + a(b["border-bottom-width"]) + a(b["padding-top"])
                + a(b["padding-bottom"]) + a(b.height)
        },
...
dat.controllers.NumberController = function (e, a) {
    var c = function (d, f, b) {
        ...
        this.__max = b.max;
        this.__step = b.step;
        d = this.__impliedStep = a.isUndefined(this.__step) ? this.initialValue == 0 ? 1 :
        Math.pow(10, Math.floor(Math.log(this.initialValue) / Math.LN10)) / 10 : this.__step;
        d = d.toString();
    ...
    a.extend(c.prototype, e.prototype, {
        setValue: function (a) {
            ...
            this.__step !== void 0 && a % this.__step != 0 && (a = Math.round(a / this.__step)
                * this.__step);
...
dat.controllers.NumberControllerBox = function (e, a, c) {
    var d = function (f, b, e) {
        ...
        a.bind(this.__input, "keydown", function (a) {
            if (a.keyCode === 13)l.__truncationSuspended = true, this.blur(),
...
dat.controllers.NumberControllerSlider = function (e, a, c, d, f) {
    var b = function (d, c, f, e, l) {
        function o(b) {
            ...
            g.setValue(g.__min + (g.__max - g.__min) * ((b.clientX - d.left) /
                (d.left + c - d.left)));
            return false
        }
...
dat.color.toString = function (e) {
    return function (a) {
        if (a.a == 1 || e.isUndefined(a.a)) {
            ...
            return "#" + a
        } else return "rgba(" + Math.round(a.r) + "," + Math.round(a.g) + "," + Math.round(a.b)
            + "," + a.a + ")"
    }
}(dat.utils.common);
        ...
        litmus: a.isString, conversions: {
            THREE_CHAR_HEX: {
                read: function (a) {
                    ...
                    return a === null ? false : {
                        space: "HEX",
                        hex: parseInt("0x" + a[1].toString() + a[1].toString() + a[2].toString()
                            + a[2].toString() + a[3].toString() + a[3].toString())
                    }
                }, write: e
            }, SIX_CHAR_HEX: {
                read: function (a) {
    ...
    return function () {
        ...
        a.each(f, function (e) {
            if (e.litmus(b))return a.each(e.conversions, function (e, f) {
                c = e.read(b);
                if (d === false && c !== false)return d = c, c.conversionName = f,
                    c.conversion = e, a.BREAK
            }), a.BREAK
        });
        return d
    }
...
dat.GUI = dat.gui.GUI = function (e, a, c, d, f, b, n, h, j, m, l, o, y, g, i) {
    ...
    function p(a, d, c) {
        ...
        if (c instanceof j) {
            ...
            var f = function (b) {
                return i.isNumber(c.__min) && i.isNumber(c.__max) ? (c.remove(),
        ...
        }); else if (c instanceof l)g.addClass(d, "color"), c.updateDisplay =
    ...
    function t(a, b) {
        ...
        if (d != -1) {
            ...
            if (c.load && c.load.remembered) {
                ...
                if (c[d] && c[d][b.property] !== void 0)d = c[d][b.property], b.initialValue = d,
                    b.setValue(d)
            }
        }
    }
    ...
    function I(a) {
        ...
        g.bind(m, "change", function () {
            for (var b = 0; b < a.__preset_select.length; b++)a.__preset_select[b].innerHTML =
        ...
        b.appendChild(f);
        if (u) {
            var b = document.getElementById("dg-save-locally"), l =
                document.getElementById("dg-local-explain");
    ...
    var x, F = true, v, A = false, G = [], k = function (a) {
        ...
        Object.defineProperties(this, {
            parent: {
                ...
                get: function () {
                    ...
                    for (b = 0; b < this.__preset_select.length; b++)if
                ...
                get: function () {
                    ...
                    a.closed = b;
                    a.closed ? g.addClass(d.__ul, k.CLASS_CLOSED) : g.removeClass(d.__ul,
                        k.CLASS_CLOSED);
                    this.onResize();
        ...
        a.autoPlace && (i.isUndefined(a.parent) && (F && (v = document.createElement("div"),
            g.addClass(v, "dg"), g.addClass(v,
            k.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(v), F = false),
            v.appendChild(this.domElement), g.addClass(this.domElement, k.CLASS_AUTO_PLACE)),
    ...
    i.extend(k.prototype, {
        add: function (a, b) {
            ...
            if (this.__folders[a] !== void 0)throw Error('You already have a folder in this ' +
                'GUI by the name "' +
                a + '"');
            var b = {name: a, parent: this};
            b.autoPlace = this.autoPlace;
            if (this.load && this.load.folders && this.load.folders[a])b.closed =
                this.load.folders[a].closed, b.load = this.load.folders[a];
            b = new k(b);
            this.__folders[a] = b;
            ...
            if (a.scrollable) {
                ...
                window.innerHeight - b - 20 < c ? (g.addClass(a.domElement, k.CLASS_TOO_TALL),
            ...
            if (!this.load.remembered)this.load.remembered = {}, this.load.remembered[w] =
                z(this, true);
            ...
            i.each(this.__controllers, function (b) {
                this.getRoot().load.remembered ? t(a || this.getRoot(), b) :
    ...
    return k
}(dat.utils.css, '<div id="dg-save" class="dg dialogue">\n\n  Here\'s the new load parameter for ' +
    'your <code>GUI</code>\'s constructor:\n\n  <textarea id="dg-new-constructor"></textarea>\n\n  ' +
    ...
    ' \n  </div>\n\n</div>',
    ".dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac" +
    "{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main" +
    "{overflow:hidden}.dg.main{-webkit-transition:opacity 0.1s linear;-o-transition:" +
    "opacity 0.1s linear;-moz-transition:opacity 0.1s linear;transition:opacity 0.1s " +
    "linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window ." +
    "close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed ." +
    "close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button." +
    "drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity 0.1s linear;-o-transition:" +
    "opacity 0.1s linear;-moz-transition:opacity 0.1s linear;transition:opacity 0.1s linear" +
    ";border:0;position:absolute;line-height:19px;height:20px;cursor:pointer;text-align:center;" +
    "background-color:#000}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;" +
    "margin-right:15px;overflow-x:hidden}.dg.a.has-save ul{margin-top:27px}.dg.a.has-save ul." +
    "closed{margin-top:0}.dg.a .save-row{position:fixed;top:0;z-index:1002}.dg li{-webkit-" +
    "transition:height 0.1s ease-out;-o-transition:height 0.1s ease-out;-moz-transition:height" +
    " 0.1s ease-out;transition:height 0.1s ease-out}.dg li:not(.folder){cursor:auto;height" +
    ":27px;line-height:27px;overflow:hidden;padding:0 4px 0 5px}.dg li.folder{padding:0;border" +
    "-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li" +
    ":not(.title),.dg .closed ul li,.dg .closed ul li > *{height:0;overflow:hidden;border:0}.dg " +
    ".cr{clear:both;padding-left:3px;height:27px}.dg .property-name{cursor:default;float:left;" +
    "clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .c{float:left;width:60%}.dg" +
    " .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg ." +
    "has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;" +
    "margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}" +
    ".dg .c input[type=checkbox]{margin-top:9px}.dg .c select{margin-top:5px}.dg .cr.function," +
    ".dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor" +
    ":pointer}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-" +
    "index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}" +
    ".dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:" +
    "#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:" +
    "10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow" +
    ":inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;" +
    "overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-" +
    "size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-" +
    "top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg" +
    "{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-" +
    "webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner" +
    "{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:" +
    "#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg" +
    " li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{mar" +
    "gin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border" +
    "-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;" +
    "color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg " +
    "li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,iVBORw" +
    "0KGgoAAAANSUhEUgAAAAsAAAANCAYAAAB/9ZQ7AAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5cc" +
    "llPAAAAQJJREFUeNpiYKAU/P//PwGIC/ApCABiBSAW+I8AClAcgKxQ4T9hoMAEUrxx2QSGN6+egDX+/vWT4e" +
    "7N82AMYoPAx/evwWoYoSYbACX2s7KxCxzcsezDh3evFoDEBYTEEqycggWAzA9AuUSQQgeYPa9fPv6/YWm/Acx" +
    "5IPb7ty/fw+QZblw67vDs8R0YHyQhgObx+yAJkBqmG5dPPDh1aPOGR/eugW0G4vlIoTIfyFcA+QekhhHJhPdQxb" +
    "iAIguMBTQZrPD7108M6roWYDFQiIAAv6Aow/1bFwXgis+f2LUAynwoIaNcz8XNx3Dl7MEJUDGQpx9gtQ8YCueB+" +
    "D26OECAAQDadt7e46D42QAAAABJRU5ErkJggg==) 2px 1px no-repeat;height:7px;width:8px}.dg li." +
    "save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder" +
    "{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64," +
    "R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px " +
    "no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li." +
    "title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////y" +
    "H5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #8" +
    "06787}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px so" +
    "lid #2fa1d6}.dg .cr.number input[type=text]{color:#2fa1d6}.dg .cr.string{border-left:3p" +
    "x solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,." +
    "dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outlin" +
    "e:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{b" +
    "ackground:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c ." +
    "slider-fg{background:#2fa1d6}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover " +
    ".slider-fg{background:#44abda}\n",
    dat.controllers.factory = function (e, a, c, d, f, b, n) {
        return function (h, j, m, l) {
            var o = h[j];
            if (n.isArray(m) || n.isObject(m))return new e(h, j, m);
            if (n.isNumber(o))return n.isNumber(m) && n.isNumber(l) ? new c(h, j, m, l) :
                new a(h, j, {
                min: m,
                max: l
            });
    ...
    }(dat.controllers.OptionController, dat.controllers.NumberControllerBox,
        dat.controllers.NumberControllerSlider, dat.controllers.StringController =
            function (e, a, c) {
        var d =
            function (c, b) {
                function e() {
        ...
        dat.controllers.FunctionController, dat.controllers.BooleanController,
        dat.utils.common), dat.controllers.Controller, dat.controllers.BooleanController,
    dat.controllers.FunctionController, dat.controllers.NumberControllerBox,
    ...
    dat.controllers.ColorController = function (e, a, c, d, f) {
        ...
        function n(a) {
            a.style.background = "";
            a.style.cssText += "background: -moz-linear-gradient(top,  #ff0000 0%, #ff00ff 17%, " +
                "#0000ff 34%, #00ffff 50%, #00ff00 67%, #ffff00 84%, #ff0000 100%);";
            a.style.cssText += "background: -webkit-linear-gradient(top,  #ff0000 0%,#ff00ff 17%," +
                "#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);";
            a.style.cssText += "background: -o-linear-gradient(top,  #ff0000 0%,#ff00ff 17%," +
                "#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);";
            a.style.cssText += "background: -ms-linear-gradient(top,  #ff0000 0%,#ff00ff 17%," +
                "#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);";
            a.style.cssText += "background: linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff " +
                "34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);"
        }
        ...
        var h = function (e, l) {
            ...
            function g() {
                var a = d(this.value);
                a !== false ? (p.__color.__state = a, p.setValue(p.__color.toOriginal())) :
            ...
            function q(b) {
                ...
                var c = a.getWidth(p.__saturation_field), d = a.getOffset(p.__saturation_field),
                    e = (b.clientX - d.left + document.body.scrollLeft) / c, b = 1 - (b.clientY -
                    d.top + document.body.scrollTop) / c;
                b > 1 ? b =
                    1 : b < 0 && (b = 0);
                e > 1 ? e = 1 : e < 0 && (e = 0);
                p.__color.v = b;
            ...
            function s(b) {
                b.preventDefault();
                var c = a.getHeight(p.__hue_field), d = a.getOffset(p.__hue_field), b = 1 -
                    (b.clientY - d.top + document.body.scrollTop) / c;
                b > 1 ? b = 1 : b < 0 && (b = 0);
                p.__color.h = b * 360;
                p.setValue(p.__color.toOriginal());
                return false
            ...
            updateDisplay: function () {
                ...
                if (a !== false) {
                    ...
                    f.each(c.COMPONENTS, function (b) {
                        if (!f.isUndefined(a[b]) && !f.isUndefined(this.__color.__state[b]) &&
                            a[b] !== this.__color.__state[b])return e = true, {}
                    }, this);
        ...
        function n(b, c, e) {
            if (b.__state.space ===
                "HEX")b.__state[c] = a.component_from_hex(b.__state.hex, e); else if
            (b.__state.space === "HSV")d.extend(b.__state, a.hsv_to_rgb(b.__state.h, b.__state.s,
                    b.__state.v)); else throw"Corrupted color state";
        }
        ...
        return {
            hsv_to_rgb: function (a, c, d) {
                var e = a / 60 - Math.floor(a / 60), b = d * (1 - c), n = d * (1 - e * c),
                    c = d * (1 - (1 - e) * c), a = [[d, c, b], [n, d, b], [b, d, c], [b, n, d],
                    [c, b, d], [d, b, n]][Math.floor(a / 60) % 6];
    ...
    dat.utils.requestAnimationFrame = function () {
        ...
        c.prototype.layout = function () {
            this.domElement.style.left = window.innerWidth / 2 -
                e.getWidth(this.domElement) / 2 + "px";
            this.domElement.style.top = window.innerHeight / 2 -
                e.getHeight(this.domElement) / 2 + "px"
        };
        return c
